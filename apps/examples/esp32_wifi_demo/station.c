...
// configurations
#define CONFIG_WIFI_CONNECT_AP_BY_SIGNAL
#define CONFIG_FAST_SCAN_THRESHOLD
#define CONFIG_WIFI_FAST_SCAN
#define CONFIG_FAST_SCAN_MINIMUM_SIGNAL -127
#define CONFIG_EXAMPLE_OPEN


/*Set the SSID and Password via "make menuconfig"*/
#define DEFAULT_SSID "SRCN-2.4G"
#define DEFAULT_PWD  "wc6rn9v3"

#define DEFAULT_PS_MODE WIFI_PS_MIN_MODEM

#if defined(CONFIG_WIFI_ALL_CHANNEL_SCAN)
#define DEFAULT_SCAN_METHOD WIFI_ALL_CHANNEL_SCAN
#elif defined(CONFIG_WIFI_FAST_SCAN)
...
static void do_wifi_scan(void)
{
    ...
    ret = esp_wifi_set_auto_connect(1);
    ets_printf("esp_wifi_set_auto_connect, %d\n", ret);
